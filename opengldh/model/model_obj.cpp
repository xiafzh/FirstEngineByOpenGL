...
void CModelObj::Init(const char*model_path)
{
	struct SFloatData
	{
		float v[3];
...
void CModelObj::SetAmbientMaterial(float r, float g, float b, float a) 
{
	m_shader->SetVec4("U_AmbientMaterial", r, g, b, a);
}
void CModelObj::SetDiffuseMaterial(float r, float g, float b, float a) 
{
	m_shader->SetVec4("U_DiffuseMaterial", r, g, b, a);
}
void CModelObj::SetSpecularMaterial(float r, float g, float b, float a) 
{
